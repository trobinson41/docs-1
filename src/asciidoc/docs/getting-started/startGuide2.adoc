...
====
[.intro]
In `App.js`, update the `Container` element with a dynamic `className`.
...
For more information, see the https://www.npmjs.com/package/ngx-spinner[package documentation].
====
...
====
[.intro]
In `app.module.ts`, import `NgxSpinnerModule` from ngx-spinner and `BrowserAnimationsModule` from @angular/platform-browser/animations.
...
. Select a default image for the logo.
You can do this by clicking *App settings* and visually selecting an image.
Alternatively, you can click *App settings*, click the *Code* tab, and entering a value for "logo". For example:
...
----
{
  "settings": {
    ...
    "logo": "https://images.koji-cdn.com/d9c6b38e-08c4-4faf-ae8e-01082c41a0fb/3f83q-9634d620e97345a6b250ca2feb7e5a2e.png"
...
----
